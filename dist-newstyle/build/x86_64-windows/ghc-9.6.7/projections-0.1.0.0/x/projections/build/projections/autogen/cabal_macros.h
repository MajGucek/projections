...
/* package projections-0.1.0.0 */
#ifndef VERSION_projections
#define VERSION_projections "0.1.0.0"
#endif /* VERSION_projections */
#ifndef MIN_VERSION_projections
#define MIN_VERSION_projections(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_projections */
...
#define CURRENT_COMPONENT_ID "projections-0.1.0.0-inplace-projections"
